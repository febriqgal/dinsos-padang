  ...
  return (
    <Layout title={"Profil Dinas - "}>
      <div>
        ...
        <div className="flex flex-col lg:flex-row gap-4 justify-center py-10 px-10 lg:px-0">
          <Button className="bg-sky-900">
            <a href="#kepaladinas">Kepala Dinas</a>
          </Button>
          <Button className="bg-sky-900">
            <a href="#visidanmisi">Visi Dan Misi</a>
          </Button>
          <Button className="bg-sky-900">
          ...
          <Button className="bg-sky-900">
            <a href="#singkatsejarah">Singkat Sejarah</a>
          </Button>
        </div>
        <div>
          <h1 id="kepaladinas" className={Styles.center}>
            Kepala Dinas
          </h1>
          <h1 id="visidanmisi" className={Styles.center}>
            Visi dan Misi
          </h1>
          <h1 id="tugasdanfungsi" className={Styles.center}>
            Tugas dan Fungsi
          </h1>
          <h1 id="strukturorganisasi" className={Styles.center}>
            Struktur Organisasi
          </h1>
          <h1 id="singkatsejarah" className={Styles.center}>
            Singkat Sejarah
          </h1>
        </div>
      </div>
